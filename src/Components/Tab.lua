...
function TabModule:New(Title, Icon, Parent)
	...
	Tab.ContainerFrame = New("ScrollingFrame", {
		...
		Visible = false,
		BottomImage = "http://www.roblox.com/asset/?id=100683126083291",
		MidImage = "http://www.roblox.com/asset/?id=98270453599530",
		TopImage = "http://www.roblox.com/asset/?id=95958774615360",
